    ...
    <div className="relative z-10 flex flex-col min-h-full p-3" style={{ fontFamily: 'monospace' }}>
      ...
      <div className="relative z-10 text-center p-3 mb-3" style={{ borderBottom: `1px solid ${primaryColor}30` }}>
        <div className="mb-4">
          ...
          >
            ...
            <h1 className="relative z-10 text-3xl font-bold mb-1.5 tracking-wider" style={{ color: '#ffffff', textShadow: '-1px -1px 0 #000, 1px -1px 0 #000, -1px 1px 0 #000, 1px 1px 0 #000' }}>
              {customHeaderText}
            </h1>
            <div className="relative z-10 text-xl" style={{ color: '#ffffff', textShadow: '-1px -1px 0 #000, 1px -1px 0 #000, -1px 1px 0 #000, 1px 1px 0 #000' }}>
      ...
      <div className="relative z-10 mt-3 text-center p-3" style={{ borderTop: `1px solid ${primaryColor}30` }}>
        <div className="inline-flex items-center gap-2">
          ...
          <span className="text-xl" style={{ color: '#ffffff', textShadow: '-1px -1px 0 #000, 1px -1px 0 #000, -1px 1px 0 #000, 1px 1px 0 #000' }}>
