  ...
  return (
    <div className="relative z-10 flex flex-col min-h-full p-3" style={{ fontFamily: 'monospace' }}>
      ...
      <div className="relative z-10 text-center p-3 mb-3" style={{ borderBottom: `1px solid ${primaryColor}30` }}>
        <div className="mb-4">
          <div className="text-xs mb-1.5 tracking-widest" style={{ color: secondaryColor }}>
            [SYSTEM INITIALIZED]
          </div>
          <img
          ...
          />
          <h1 className={`${getFontSizeClass()} font-bold mb-1.5 tracking-wider`} style={{ color: primaryColor, textShadow: `0 0 20px ${primaryColor}` }}>
            {customHeaderText}
          </h1>
          <div className="text-base opacity-80" style={{ color: secondaryColor }}>
