...
function CasinoGameCard({ game, rtp, primaryColor, secondaryColor, isShowcase = false, darkBackground }: CasinoGameCardProps) {
  ...
  return (
    ...
    >
      ...
      <div className="p-3">
        <h3 className="font-semibold text-sm text-center truncate" style={{ color: '#ffffff', textShadow: '-1px -1px 0 #000, 1px -1px 0 #000, -1px 1px 0 #000, 1px 1px 0 #000' }}>
          {game.name}
        </h3>
      </div>
    </div>
  ...
  return (
    <div className="relative z-10 flex flex-col min-h-full p-3" style={{ fontFamily: "var(--font-cinzel), serif" }}>
      ...
      >
        ...
        />
        <div className="text-lg mb-1.5" style={{ color: '#ffffff', textShadow: '-1px -1px 0 #000, 1px -1px 0 #000, -1px 1px 0 #000, 1px 1px 0 #000', letterSpacing: "4px" }}>
          {customHeaderText}
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-2 mb-1.5 relative z-10">
        ...
        >
          ...
          >
            <span className="text-base font-bold tracking-widest" style={{ color: '#ffffff', textShadow: '-1px -1px 0 #000, 1px -1px 0 #000, -1px 1px 0 #000, 1px 1px 0 #000' }}>
              FEATURED
            </span>
          </div>
